...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	public  void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/welcome.htm").access("permitAll")
			.antMatchers("/wish.htm").access("hasRole('ROLE_STUDENT')")
			.antMatchers("/about_us.htm").access("hasAnyROLE('ROLE_STUDENT','ROLE_ENQUIRY')")
			.antMatchers("/contact_us.htm").access("hasAnyRole('ROLE_STUDENT','ROLE_ENQUIRY')")
			.and()
			.formLogin()
			.and()
			.rememberMe()
